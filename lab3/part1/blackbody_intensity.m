function [ intensity ] = blackbody_intensity( wavelengths, temperature )
...
intensity = 2 * planck_constant * speed_of_light^2 / ( wavelengths.^5 * ( exp(planck_constant * speed_of_light / ( wavelengths .* ( boltzmann_constant * temperature ))) - 1 ));
