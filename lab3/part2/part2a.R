...
for (current_known_spectra in spectral_types)
  known_spectra[[current_known_spectra]] <- read.csv(paste("spectra/", current_known_spectra, ".txt", sep = ""))$normalized_intensity

# read unknown spectral data
for (current_unknown_spectra in paste("unknown", 1:5, sep = ""))
  unknown_spectra[[current_unknown_spectra]] <- read.csv(paste("spectra/", current_unknown_spectra, ".txt", sep = ""))$normalized_intensity
