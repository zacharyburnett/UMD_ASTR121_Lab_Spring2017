unknown1_data = readtable('lab3\spectra\unknown1.txt', 'ReadVariableNames', true);
...
for spectral_type in spectral_types:
    spectral_standards(spectral_type) = readtable('lab3\spectra\' + spectral_type + '.txt', 'ReadVariableNames', true).normalized_wavelength;
